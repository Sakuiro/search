...
function (t) {
    ...
    o.prototype.set = function (e, n, o) {
        ...
        return "string" == typeof n ? n.format(t.extend({}, i, {
            page: e
        })) : t.isFunction(n) ? n(e, i) : "#page=" + e
    ...
    t.fn.collapse = function (n) {
        return this.each(function () {
            var o = t(this),
                a = o.data(e),
                s = t.extend({}, i.DEFAULTS, o.data(), "object" == typeof n && n);
    ...
    String.prototype.format || (String.prototype.format = function (t) {
        ...
        if (arguments.length > 0) {
            ...
            if (arguments.length <= 2 && "object" == typeof t)
                for (var n in t) void 0 !== t[n] && (i = new RegExp("(" + (arguments[1] ? arguments[1].replace("0", n) : "{" + n + "}") + ")", "g"), e = e.replace(i, t[n]));
            else
                for (var o = 0; o < arguments.length; o++) void 0 !== arguments[o] && (i = new RegExp("({[" + o + "]})", "g"), e = e.replace(i, arguments[o]))
        }
        return e
...
function (t, e) {
    ...
    s.prototype.pageSave = function () {
        if (e.isEmptyObject(this.page)) this.remove(a);
        else {
            var t, i = [];
            for (t in this.page) {
                var n = this.page[t];
...
function (t, e, i) {
    ...
    s.DEFAULTS = o, s.NAME = n, s.prototype.trigger = function (e, i) {
        ...
        var o, a, s, r, l, c, d, p, h, u, f, g, m, v = this,
            y = v.$,
            b = v.options,
            w = b.deviation,
            C = "." + n + "." + v.id,
            ...
            P = y,
            I = !1,
            M = S ? t(b.container).first() : k ? y : t("body"),
            j = function (e) {
                if (I && (f = {
                        left: e.pageX,
                        top: e.pageY
                    }, !(i.abs(f.left - p.left) < w && i.abs(f.top - p.top) < w))) {
                    if (null === s) {
                        ...
                        "absolute" != n && "relative" != n && "fixed" != n && (c = n, M.css("position", "relative")), s = P.clone().removeClass("drag-from").addClass("drag-shadow").css({
                            ...
                            width: P.outerWidth(),
                            transition: "none"
                        }).appendTo(M), P.addClass("dragging"), v.trigger("start", {
                            event: e,
                            element: P
                        })
                    }
    ...
    function e(e, o, a) {
        return this.each(function () {
            var s = t(this),
                r = s.data(i),
                l = t.extend({}, n.DEFAULTS, s.data(), "object" == typeof e && e);
    ...
    n.prototype.toggle = function (t, e) {
        ...
        if ("undefined" == typeof e && (e = a.position), "undefined" != typeof e) {
            var s = n.$element.find(".modal-dialog"),
                r = Math.max(0, (t(window).height() - s.outerHeight()) / 2),
        ...
        var e = this,
            n = e.options,
            a = e.$element.find(".modal-dialog").removeClass("modal-dragged");
        ...
        this.isShown && this.options.keyboard ? t(document).on("keydown.dismiss." + i, t.proxy(function (e) {
            if (27 == e.which) {
                var n = t.Event("escaping." + i),
                    o = this.$element.triggerHandler(n, "esc");
...
function (t, e) {
    ...
    s.DEFAULTS = {
        ...
        var r = this;
        if (s.url && (!s.type || s.type != n && "iframe" != s.type) && (s.type = n), s.remote) s.type = n, typeof s.remote === a && (s.url = s.remote);
        else if (s.iframe) s.type = "iframe", typeof s.iframe === a && (s.url = s.iframe);
        else if (s.custom && (s.type = "custom", typeof s.custom === a)) {
            var l;
            try {
                l = t(s.custom)
            } catch (c) {}
        ...
        var r = this,
            ...
            c = this.$dialog,
            d = s.custom,
            p = c.find(".modal-body").css("padding", ""),
            h = c.find(".modal-header"),
            u = c.find(".modal-content");
        ...
        if ("custom" === s.type && d)
            ...
            } else d instanceof t ? (p.html(t("<div>").append(d.clone()).html()), g()) : (p.html(d), g());
        else if (s.url) {
            var v = function () {
    ...
    t.zui({
        ...
        a && a.length || (n.data(i) ? n.trigger(".toggle." + i) : n.modalTrigger({
            show: !0
...
function (t, e) {
    ...
    var i = "zui.contextmenu",
        ...
        u = function (c, u, f) {
            ...
            var y = v.find(".contextmenu-menu").off("click." + i).on("click." + i, "a", function (e) {
                var i = t(this),
                    n = u.onClickItem && u.onClickItem(i.data("item"), i, e);
                n !== !1 && h()
            }).empty();
            v.hide().attr("class", "contextmenu");
            var b = u.itemCreator || d,
                w = typeof c;
    ...
    var f = function (e, n) {
        var o = this;
        o.name = i, o.$ = t(e), n = o.options = t.extend({
            trigger: "contextmenu"
        }, a.DEFAULTS, this.$.data(), n);
        var s = n.trigger;
        o.id = t.zui.uuid();
        var r = function (t) {
            ...
            switch (e.type) {
                ...
                case "touchend":
                    var s = e.changedTouches[0].pageX - n,
                        r = e.changedTouches[0].pageY - o;
                    if (Math.abs(s) > Math.abs(r)) i(a, s), Math.abs(s) > 10 && e.preventDefault();
                    else {
                        var l = t(window);
                        t("body,html").animate({
                            scrollTop: l.scrollTop() - r
                        }, 400)
                    }
            }
        }
    ...
    n.DEFAULTS = {
        ...
        return !!a.image && void n.modalTrigger({
            ...
            custom: function (n) {
                ...
                var c = s.find(".modal-dialog"),
                    d = t(e).width();
                t.zui.imgReady(a.image, function () {
                    c.css({
                        width: i.min(d, this.width)
                    }), d < this.width + 30 && s.addClass("lightbox-full"), n.ready(200)
                    ...
                    if (l.length) {
                        ...
                        s.addClass("modal-loading").data("group-index", a).toggleClass("lightbox-with-caption", "string" == typeof h).removeClass("lightbox-full"), s.find(".lightbox-img").attr("src", p), s.find(".caption > .content").text(h), d = t(e).width(), t.zui.imgReady(p, function () {
                            c.css({
                                width: i.min(d, this.width)
                            }), d < this.width + 30 && s.addClass("lightbox-full"), n.ready()
                        })
                    }
...
function (t, e, i, n) {
    ...
    var d = /^#([0-9a-fA-f]{3}|[0-9a-fA-f]{6})$/,
        ...
        C = function (t, e, i, n) {
            var a = this;
            if (a.r = a.g = a.b = 0, a.a = 1, y(n) && (a.a = l(c(n), 1)), y(t) && y(e) && y(i)) a.r = w(t), a.g = w(e), a.b = w(i);
            else if (y(t)) {
                var r = typeof t;
                if (r == f) t = t.toLowerCase(), "transparent" === t ? a.a = 0 : m[t] ? this.rgb(o(m[t])) : a.rgb(o(t));
                else if ("number" == r && v(e)) a.r = a.g = a.b = w(t);
                else if (r == g && y(t.r)) a.r = w(t.r), y(t.g) && (a.g = w(t.g)), y(t.b) && (a.b = w(t.b)), y(t.a) && (a.a = l(c(t.a), 1));
                else if (r == g && y(t.h)) {
                    var d = {
                        h: l(c(t.h), h),
                        s: 1,
    ...
    C.prototype.rgb = function (t) {
        var e = this;
        if (y(t)) {
            if (typeof t == g) y(t.r) && (e.r = w(t.r)), y(t.g) && (e.g = w(t.g)), y(t.b) && (e.b = w(t.b)), y(t.a) && (e.a = l(c(t.a), 1));
            else {
                var i = b(c(t));
                e.r = i, e.g = i, e.b = i
            }
...
function (t) {
    ...
    function e(e, i) {
        ...
        return t.isArray(e) && (n = {}, t.each(e, function (e, i) {
            ...
            i ? n[e] = t.extend({
                type: e
            }, s[e], t.isPlainObject(i) ? i : null) : n[e] = !1
    ...
    a.DEFAULTS = {
        ...
        r && (this.selector = n + "::" + (i.name || "") + "#" + (this.$.attr("id") || o++), this.store = t.zui.store[i.name ? "get" : "pageGet"](this.selector, {})), "preserve" === s && (r ? this.isPreserve = !0 : this.options.initialState = s = "normal"), this.reload(i.data), r && (this.isPreserve = !0), "expand" === s ? this.expand() : "collapse" === s && this.collapse(), this.$.on("click", '.list-toggle,a[href="#"],.tree-toggle', function (e) {
            ...
            a.callEvent("hit", {
                target: n,
                item: n.data()
            }), a.toggle(n), i.is("a") && e.preventDefault()
        ...
        if (this.isPreserve)
            if (e) i = i || e.data("id"), n = void 0 === n && e.hasClass("open"), n ? this.store[i] = n : delete this.store[i], this.store.time = (new Date).getTime(), t.zui.store[this.options.name ? "set" : "pageSet"](this.selector, this.store);
            else {
                var o = this;
        ...
        e.each(function () {
            var e = t(this);
            if (o.expand(e, i, n), e)
                for (var a = e.parent("ul"); a && a.length && !a.hasClass("tree");) {
                    var s = a.parent("li");
